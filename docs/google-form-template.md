...
> "No restrictions" is an explicit option (not just leaving blank) so we can distinguish "guest confirmed they have none" from "guest didn't answer." That distinction matters for the **Dietary surprises = 0** metric in `metrics.md`.
