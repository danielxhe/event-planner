...
Maya started hosting in earnest after grad school in 2022. Her gatherings have a reputation. Guests know there will be name tags for the first hour, a thoughtful non-alcoholic option beyond LaCroix, and a real vegetarian main. She tracks dietary restrictions in a personal Notes app file that she copies forward event-to-event. The file is two screens long now and she has no idea which entries are still accurate.
...
- **Sam can't help meaningfully.** He'd take the schedule and grocery run off her plate, but the info lives in her head and on her phone, with no shared surface.
...
- Built-in payment splitting (she trusts Venmo and doesn't want a half-baked clone; see [PRD §4 out-of-scope](PRD.md#4-scope)).
...
Sam is Maya's partner and her default second-in-command for every gathering. He doesn't initiate events but he genuinely enjoys executing them; he likes the puzzle of fitting 20 people around their dining table plus the kitchen island plus three folding chairs. His pain is information asymmetry.
...
- **Add or edit things himself.** If Marcus texts him saying "I'll bring speakers but only until 10," Sam wants to update that in the plan directly instead of relaying it to Maya.
...
- **He feels like a helper instead of a co-host.** What he wants is clarity about ownership, not a title. He'd take ownership if there were defined ownership to take.
...
- **One link to bookmark** with address, time, what she's bringing, and dress code all in one place.
...
- Her shift gets swapped Saturday morning. She opens the same Form link, changes her RSVP to No, and adds a note. Maya sees it within an hour, with no group-chat drama.
...
| 10 | **Spot gaps** | `Potluck Coverage: 92%`, one Side slot still open. DMs Priya, who'd RSVP'd Yes but not claimed | Events DB rollup | Confident | Today: she'd discover the gap at 6:45 pm Saturday when 18 people walk in with 3 desserts | Coverage rollup makes the gap visible Wednesday instead of Saturday |
...
| 17 | **Wind down** | Last guests leave 11pm. Dishes. Bed | Real life | Tired but happy | n/a | n/a |
...
| 6 | **Forget about it for 2 weeks** | Life. Work. Three 12-hour shifts | Brain | Distracted | n/a | n/a |
...
| 11 | **Event happens** | Eats, plays mahjong, leaves at 10:45pm | Real life | Joyful | n/a | n/a |
...
1. **Should the Form support "edit my response" links?** Jess's journey assumes yes (Stage 8). Google Forms requires "Edit after submit" toggle + sending the unique edit URL in the confirmation email. Low-cost win; should ship in MVP.
